...
use crate::plugin_edit::PluginConfigEdit;
use crate::plugin_edit::apply_plugin_config_edit;
...
impl ConfigEditsBuilder {
    ...
    pub fn set_plugin_enabled(mut self, plugin_id: &str, enabled: bool) -> Self {
        self.plugin_edits
            .push(PluginConfigEdit::set_enabled(plugin_id, enabled));
        self
    }

    pub fn clear_plugin(mut self, plugin_id: &str) -> Self {
        self.plugin_edits.push(PluginConfigEdit::clear(plugin_id));
        self
    }
