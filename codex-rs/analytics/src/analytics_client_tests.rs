...
fn sample_command_approval_request(
    request_id: i64,
    approval_id: Option<&str>,
    source: AppServerGuardianCommandSource,
) -> ServerRequest {
...
fn sample_permissions_approval_response(
    request_id: i64,
...
async fn command_execution_approval_response_publishes_user_review_event() {
        ...
        .ingest(
            AnalyticsFact::ServerRequest {
                ...
                request: Box::new(sample_command_approval_request(
                    /*request_id*/ 41,
                    /*approval_id*/ None,
                    AppServerGuardianCommandSource::Shell,
                )),
            },
            &mut events,
        )
    ...
    assert_eq!(payload[0]["event_params"]["subject_name"], "shell");
...
async fn permissions_reviews_emit_events_without_denormalizing_onto_tool_items() {
    ...
    reducer
        .ingest(
            AnalyticsFact::ServerResponse {
                completed_at_ms: 1_042,
                response: Box::new(sample_permissions_approval_response(
                    /*request_id*/ 51,
