...
/// layered on top of the baseline helper roots that the elevated setup path
/// needs to launch the sandboxed command; split policies that opt into platform
/// defaults carry that explicitly with the override.
