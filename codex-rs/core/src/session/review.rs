...
pub(super) async fn spawn_review_thread(
    ...
    .with_has_environment(parent_turn_context.has_attached_environment())
    .with_has_multiple_environments(parent_turn_context.has_multiple_selected_environments())
